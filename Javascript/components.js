...
var htmlpopup = {
    ...
    'Motherboard':'A motherboard provides connectivity between the hardware components of a computer. Motherboards come in differnt form factors, which are their size and general layout. These form factors are meant for specific types of cases. Motherboards also have the BIOS, which are where most input and output will be attached, such as USB, HDMI and audio ports. The correct BIOs should be chosen for the input and output devices you will be using.',
