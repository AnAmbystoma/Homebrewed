...
function showpopup(x){
    ...
    if (x == 'Prepare Operating System'){
        popuptop.innerHTML = "<img src='css/Resources/download\ OS.png'>";
        text.innerHTML = htmlpopup[x];
    }else if (x == 'Configure BIOS'){
        popuptop.innerHTML = "<img src='css/Resources/BIOS\ page.png'>";
        text.innerHTML = htmlpopup[x];
    }else if (x == 'Prepare Motherboard'){
        popuptop.innerHTML = "<img src='css/Resources/Prepare\ motherboard2.jpg'>";
        text.innerHTML = htmlpopup[x];
    }else if (x == 'Install Fan *OPTIONAL*'){
        popuptop.innerHTML = "<img src='css/Resources/fans.jpg'>";
        text.innerHTML = htmlpopup[x];
    }else if (x == 'Congratulations!'){
        popuptop.innerHTML = "<img src='css/Resources/congrats.jpeg'>";
        confetti.style.display = "block";
        text.innerHTML = htmlpopup[x];
    }else{
        popuptop.innerHTML = "<img src='css/Resources/blank.png'>";
